      ...
      <div className=" max-w-screen-2xl container mx-auto md:px-20 px-4">
        <div className="mt-28 items-center justify-center text-center">
          ...
          <p className="mt-12">
            ...
            genres to suit every reader’s passion. From thrilling mysteries and
            ...
            something for everyone! 📚 Check out our latest book collections
            below and start your literary journey today. New books and exciting
            reads are added regularly—discover your next favorite now! 🚀
          </p>
          <Link to="/">
